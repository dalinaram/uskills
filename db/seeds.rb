...
@user = User.create( email: "ahmed@gmail.com", name: "ahmed", last_name: "salah", interest: "learning", address: "4 rue de Picardie 75003 Paris", rating: 3, role: "learn", password: "123456")
